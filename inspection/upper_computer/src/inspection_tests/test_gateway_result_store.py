...
from inspection_hmi_gateway.read_model_repository import ReadModelSyncRequiredError
...
def test_result_store_requires_explicit_repair_when_trace_files_change(tmp_path: Path) -> None:
    ...
    try:
        ...
        raise AssertionError('stale trace files must require explicit repair')
