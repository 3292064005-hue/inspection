...
_STATION_BRIDGE_KEYS = {'adapter_name','protocol_version','supported_action_codes','serial_port','baudrate','position_delay_sec','sort_delay_sec','heartbeat_sec','ack_stale_timeout_sec','heartbeat_watchdog_sec','enable_startup_handshake'}
...
def build_launch_runtime_payload(*, recipe_path: str, station_config_path: str, camera_config_path: str, profile_name: str, compatibility_path: str, package_name: str = 'inspection_bringup') -> dict[str, Any]:
    resolved_recipe_path = str(resolve_resource_path(recipe_path, package_name=package_name, start=__file__))
    resolved_station_path = str(resolve_resource_path(station_config_path, package_name=package_name, start=__file__))
    resolved_camera_path = str(resolve_resource_path(camera_config_path, package_name=package_name, start=__file__))
    resolved_compatibility_path = str(resolve_resource_path(compatibility_path, package_name=package_name, start=__file__))
    resolved_profile_path = str(resolve_resource_path(str(Path('config/profiles') / f'{profile_name}.yaml'), package_name=package_name, start=__file__))
