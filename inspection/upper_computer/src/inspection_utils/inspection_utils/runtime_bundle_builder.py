...
def build_effective_runtime_bundle(
    *,
    ...
    Boundary behavior:
        ...
        Station adapter/protocol defaults are materialized before validation so
        the validator checks the same contract that runtime nodes will execute.
    """
    ...
    try:
        effective_station_cfg = normalize_station_runtime_config(deep_merge_dicts(station_cfg, profile_bundle.get('station_overrides', {})))
    ...
    return {
        ...
        'summary': {
            ...
            'station_protocol_version': str(effective_station_cfg.get('protocol_version', 'v1') or 'v1'),
