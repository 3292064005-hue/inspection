...
try:
    from inspection_interfaces.msg import ActionExecutorEvent, CaptureRequest, ControlCommand, DiagnosticsSnapshot
except ImportError:  # pragma: no cover - ROS interface generation unavailable in unit-test environments
    ActionExecutorEvent = CaptureRequest = ControlCommand = DiagnosticsSnapshot = None
