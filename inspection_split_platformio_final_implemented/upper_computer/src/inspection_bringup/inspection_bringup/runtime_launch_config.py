...
_STATION_BRIDGE_KEYS = {'serial_port','baudrate','position_delay_sec','sort_delay_sec','heartbeat_sec','ack_stale_timeout_sec','heartbeat_watchdog_sec','enable_startup_handshake'}
