...
def test_read_model_repository_trace_refresh_preserves_hot_projection_state(tmp_path: Path) -> None:
    log_root = tmp_path / 'logs'
    _seed_runtime_dirs(log_root)
    ...
    trace_path.write_text(
        '{"type":"cycle_finish","trace_id":"trace-hot"}\n'
        '{"type":"inspection_result","trace_id":"trace-hot"}\n',
        encoding='utf-8',
    )
