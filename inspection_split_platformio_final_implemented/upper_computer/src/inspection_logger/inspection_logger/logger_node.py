...
class LoggerNode(ManagedNodeMixin, InspectionRuntimeNode):
    def __init__(self) -> None:
        ...
        self.declare_parameter('bag_topics', ['/inspection/image_raw', '/inspection/result', '/inspection/decision/final', '/station/state', '/inspection/events', '/inspection/diagnostics'])
